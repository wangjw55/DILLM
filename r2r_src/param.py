...
class Param:
    def __init__(self):
        ...
        # Hierarchical RL
        self.parser.add_argument("--option_step", type=int, default=2)
        self.parser.add_argument("--option_size", type=int, default=8)
        self.parser.add_argument('--obj_dim', type=int, default=640)
