...
from utils import load_datasets, load_nav_graphs, Tokenizer, read_obj_features
OBJ_FEATURES = 'img_features/CLIP-obj-RN50-4-1e-6.tsv'
...
class EnvBatch():
    ...
    def __init__(self, feature_store=None, batch_size=100):
        ...
        self.obj_features = read_obj_features(OBJ_FEATURES)
    ...
    def getStates(self):
        ...
        for i, sim in enumerate(self.sims):
            ...
            if self.features:
                ...
                obj_feature = self.obj_features[long_id]
                feature_states.append((feature, obj_feature, state))
            else:
...
class R2RBatch():
        ...
        for split in splits:
            for item in load_datasets([split]):
                ...
                for j,instr in enumerate(item['instructions']):
                    ...
                    # Add preprocessed sub-instructions
                    new_item['subgoals'] = item['subgoals'][j]
                    if tokenizer:
        ...
        if long_id not in self.buffered_state_dict:
            for ix in range(36):
                ...
                for j, loc in enumerate(state.navigableLocations[1:]):
                    ...
                    # view (in angular distance) as its representatione
    ...
    def _get_obs(self):
        obs = []
        for i, (feature, obj_feature, state) in enumerate(self.env.getStates()):
            item = self.batch[i]
            ...
            # (12,512) -> (36,512)
            obj_feat = np.tile(obj_feature, (3,1))
